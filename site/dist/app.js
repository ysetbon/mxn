...
import {renderDocument} from './browser-render.js';
...
// Without the local renderer, starting stitches are generated by generators.js and drawn by browser-render.js.
async function renderInBrowser(s) {
  const document=applyColors(generateDocument(s.m,s.n,s.hand,s.stretch),s.colors);
  return {...await renderDocument(document,s),document,settings:s,engine:'browser'};
}
